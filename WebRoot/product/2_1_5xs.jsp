									...
									<TD class=unnamed1 vAlign=top height=9><TABLE width="99%"
											...
											<TBODY>
												<TR bgColor=#ffffff height=20>
													...
													<TD width=31% noWrap><span class="foot3"><%=map.get("name")%></span>
													</TD>
													<TD width=18% align="center" noWrap><span
														class="STYLE7">公司</span></TD>
													<TD width=38% noWrap><span class="STYLE7"> <%=map.get("company")%>
													</span></TD>
												</TR>
												<TR bgColor=#ffffff height=20>
													<TD width=13% align="center" noWrap class="STYLE7">部门</TD>
													<TD width=31% noWrap colspan="3"><span class="STYLE7">
															<%=map.get("department")%> </span>
													</TD>
												</TR>
												<TR bgColor=#ffffff height=20>
													<TD height="-1" align="center" noWrap><span
														class="STYLE7">手机号码</span></TD>
													<TD width=31% noWrap colspan="3"><span class="STYLE7">
															<%=map.get("phonenum")%> </span>
													</TD>
												</TR>
											</TBODY>
										</TABLE> <br></TD>
