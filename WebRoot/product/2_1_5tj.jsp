      ...
      <TBODY>
        <TR>
          <TD vAlign=bottom width=548 height=27><IMG height=10 
            src="<%=path %>/images/jt2.gif" width=10> <span class="lbt">人员信息管理&gt;&gt;人员信息添加 </span></TD>
        ...
        border=0 cellPadding=4 cellSpacing=1 bgColor=#0867b3>
            ...
            size=18 name="name" minLength="1"></span></TD>
                  <TD width=18% align="center" noWrap><span class="STYLE7">公司</span></TD>
                  <TD width=38% noWrap><span class="STYLE7">
                    <INPUT class=text2  maxLength=20 
            size=18 name="company" minLength="1">
                  </span></TD>
                  </TR>
                <TR bgColor=#ffffff height=20>
                  ...
                  <span class="STYLE7">
                    <INPUT class=text2  maxLength=20 
            size=30 name="department" minLength="1">
                  </span>
                  </TD>
                </TR>
                <TR bgColor=#ffffff height=20>
                  <TD width=13% align="center"  noWrap class="STYLE7">手机号码</TD>
                  <TD width=31% noWrap colspan="3">
                  <span class="STYLE7">
                    <INPUT class=text2  maxLength=20 
            size=30 name="phonenum" minLength="1">
                  </span>
                  </TD>
                </TR>
              </TBODY>
