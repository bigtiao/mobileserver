...
<%@ page import="com.scents.mobile.tools.*"%>
<%
							...
							<TBODY>
								<TR>
									<TD vAlign=bottom width=548 height=27><IMG height=10
										...
										class="lbt">人员信息模块&gt;&gt;人员信息查询</span></TD>
										...
										<TABLE width="99%" border=0 cellPadding=4 cellSpacing=1
											...
											<TBODY>
												<TR bgColor=#ffffff height=20>
													<TD width=13% noWrap class="STYLE7">姓名</TD>
													<TD width=31% noWrap><span class="STYLE7"> <INPUT
															class=text2 maxLength=20 size=18 name="name"
															minLength="1" value="<%=name%>"> </span></TD>
										...
										<TABLE width="99%" border=0 cellPadding=4 cellSpacing=1
											...
											<TBODY>
												<TR bgColor=#ffffff height=20>
													...
													<TD width=70 align="center" noWrap class="STYLE7">姓名</TD>
													<TD width=60 align="center" noWrap class="STYLE7">公司</TD>
													<TD width=128 align="center" noWrap class="STYLE7">部门</TD>
													<TD width=128 align="center" noWrap class="STYLE7">电话</TD>
												</TR>
												<%
													if (!list.isEmpty()) {
												...
												<TR bgColor=#ffffff height=2>
													...
													<TD align="center" valign="middle" noWrap><span
														class="foot3"><%=map.get("name")%></span></TD>
													<TD align="center" valign="middle" noWrap class="foot3"><%=map.get("company")%></TD>
													<TD align="center" valign="middle"><span class="foot3"><%=map.get("department")%></span>
													</TD>
													<TD align="center" valign="middle"><span class="foot3"><%=map.get("phonenum")%></span>
													</TD>
												</TR>
												<%
													}
